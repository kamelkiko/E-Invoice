...
data class HistoryUiState(
    ...
    val receipts: List<HistoryDetailsUiState> = emptyList(),
    val selectedReceipts: List<HistoryDetailsUiState> = emptyList(),
...
data class ReceiptPageInfoUiState(
    val data: List<HistoryDetailsUiState> = emptyList(),
...
fun List<HistoryData>.toDetailsUiState() = map { it.toHistoryDetailsUiState() }

fun DocumentDetailsData.toDetailsUiState(): HistoryDetailsUiState {
